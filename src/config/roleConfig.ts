...
export const roleConfig: Record<UserRole, RoleConfigEntry> = {
  SUPER_ADMIN: {
    ...
    sidebar: [
      ...
      { href: "/admin/master-data", label: "Master Data", icon: "SlidersHorizontal", navGroup: "masterData" },
      ...
      { href: "/admin/candidates/bulk-import", label: "Bulk Import", icon: "Upload", navGroup: "admin" },
      { href: "/admin/candidates/deployment-bulk-import", label: "Deployment Import", icon: "Briefcase", navGroup: "admin" },
